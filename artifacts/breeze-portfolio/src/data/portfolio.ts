...
export const portfolio = {
  ...
  projects: [
    ...
    },
    {
      ...
      title: 'Nagode.io',
      category: 'Web Apps',
      eyebrow: 'Payment and wallet infrastructure',
      description: 'A cloud-first payment and wallet platform built around financial correctness, secure payment orchestration, and operational visibility.',
      detail: 'Nagode.io uses a Next.js frontend, Spring Boot backend, and PostgreSQL financial core. It is designed around an immutable double-entry ledger, atomic balance updates, explicit payment state transitions, durable idempotency, signed webhooks, transactional outbox delivery, refunds, and reconciliation.',
      status: 'Featured',
      accent: '#d5ff65',
      index: '01',
    },
    ...
    },
    {
      ...
      title: 'PayChad',
      category: 'Web3',
      eyebrow: 'Programmable payroll and business payouts on Monad',
      description: 'A Monad-native programmable stablecoin payroll and business-payout platform for funding and executing payroll on-chain.',
      detail: 'PayChad combines a Next.js wallet interface, Fastify API, PostgreSQL projections, and smart contracts on Monad. Blockchain state remains authoritative for company ownership, payroll funding, payroll execution, and token movement, while indexed events provide reliable off-chain history and coordination.',
      status: 'Featured',
      accent: '#d5ff65',
      index: '01',
    },
